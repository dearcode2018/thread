 ...
 * @author qianye.zheng
 */
public class SearchUserTaskCallable2 implements Callable<String>
{
	 ...
	 * @author qianye.zheng
	 */
	public SearchUserTaskCallable2(Integer pageSize)
	{
		super();
	...
	{
		System.out.println("SearchUserTaskCallable2.call()");
		// 构造请求对象
