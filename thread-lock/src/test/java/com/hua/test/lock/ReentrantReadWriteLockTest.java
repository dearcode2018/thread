...
import com.hua.lock.ReentrantReadWriteLockCase;
 ...
 */
public final class ReentrantReadWriteLockTest extends BaseTest {
	...
	public void testReentrantReadWriteLock() {
		try {
			ReentrantReadWriteLockCase reentrantReadWriteLockCase = new ReentrantReadWriteLockCase();
			...
			Runnable writeValueTask = new Runnable() {
				...
				public void run()
				{
					reentrantReadWriteLockCase.writeValue(25.2);
				}
			};
			...
			Runnable readValueTask = new Runnable() {
				...
				public void run()
				{
					reentrantReadWriteLockCase.readValue();
					//System.out.println("value = " + reentrantReadWriteLockCase.readValue());
				}
			};
			// 任务执行服务，构造可缓存的线程池
